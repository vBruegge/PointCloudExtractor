...
public:
    ...
    void writingWingDataInCSV( std::ofstream& outStream, airfoilParameters data[], std::string sectionType, int length);

    void writingFuselageDataInCSV( std::ofstream& outStream, fuselageParameters data[], int length);
